...
CREATE TABLE `t_password` (
  `id` bigint(64) NOT NULL COMMENT '密码主键',
  `account_id` bigint(64) NOT NULL COMMENT '账号 ID',
...
CREATE TABLE `t_role` (
  `id` bigint(64) NOT NULL COMMENT '角色主键',
  `account_id` bigint(64) NOT NULL COMMENT '账号 ID',
  ...
  PRIMARY KEY (`id`),
  KEY `account_id` (`account_id`),
  CONSTRAINT `t_role_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `t_account` (`id`)
