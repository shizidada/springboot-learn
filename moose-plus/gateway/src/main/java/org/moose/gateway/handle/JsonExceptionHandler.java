package org.moose.gateway.handle;
 ...
 * @author taohua
 * @version v1.0.0
 * @date 2020-03-25 14:27:14:27
 * @see org.moose.gateway.handle
 */
public class JsonExceptionHandler implements ErrorWebExceptionHandler {
  ...
  public Mono<Void> handle(ServerWebExchange serverWebExchange, Throwable throwable) {
    ...
    log.error("[全局系统异常] 请求路径：{} 异常记录：{}", request.getPath(), throwable.getMessage());
